...
public class DiffTest extends TestCase {
	...
	public void testDiff_Insert() {
		...
		assertEquals(new Chunk(1, 0, new LinkedList<String>()), 
				delta.getOriginal());
		assertEquals(new Chunk(1, 2, new LinkedList<String>() {{ add("jjj"); add("kkk"); }}), 
				delta.getRevised());
	}
	...
	public void testDiff_Delete() {
		...
		assertEquals(new Chunk(0, 2, new LinkedList<String>() {{ add("ddd"); add("fff"); }}), 
				delta.getOriginal());
		assertEquals(new Chunk(0, 0, new LinkedList<String>()), 
				delta.getRevised());
	}
	...
	public void testDiff_Change() {
		...
		assertEquals(new Chunk(1, 1, new LinkedList<String>() {{ add("bbb"); }}), 
				delta.getOriginal());
		assertEquals(new Chunk(1, 1, new LinkedList<String>() {{ add("zzz"); }}), 
				delta.getRevised());
	}
}
