...
public class DiffUtilsTest {
		...
		public void testDiffIntegerList() {
				...
				assertEquals(
								...
								patch.getDeltas().get(1).toString());
		}
		...
		public void testDiffMyersExample1() {
				final Patch<String> patch = DiffUtils.diff(
								Arrays.asList("A", "B", "C", "A", "B", "B", "A"), Arrays.asList("C", "B", "A", "B", "A", "C"));
				assertNotNull(patch);
		...
		public void testDiff_Equal() {
				final Patch<String> patch =
								DiffUtils.diff(Arrays.asList("hhh", "jjj", "kkk"), Arrays.asList("hhh", "jjj", "kkk"), true);
				assertNotNull(patch);
				assertEquals(1, patch.getDeltas().size());
				final AbstractDelta<String> delta = patch.getDeltas().get(0);
		...
		public void testDiff_InsertWithEqual() {
				final Patch<String> patch = DiffUtils.diff(Arrays.asList("hhh"), Arrays.asList("hhh", "jjj", "kkk"), true);
				assertNotNull(patch);
				assertEquals(2, patch.getDeltas().size());
		...
		public void testDiff_ProblemIssue42() {
				final Patch<String> patch = DiffUtils.diff(
								Arrays.asList("The", "dog", "is", "brown"), Arrays.asList("The", "fox", "is", "down"), true);
		...
		public void testDiffPatchIssue189Problem() throws IOException {
				String original = new String(Files.readAllBytes(
								Paths.get("target/test-classes/com/github/difflib/text/issue_189_insert_original.txt")));
				String revised = new String(Files.readAllBytes(
								Paths.get("target/test-classes/com/github/difflib/text/issue_189_insert_revised.txt")));
